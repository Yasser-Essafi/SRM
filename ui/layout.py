    ...
    with st.sidebar:
        ...
        <div class="sidebar-info">
            ...
            <ol>
                ...
                <li>قدم رقم العقد الخاص بك (مثال: 3701455886 / 1014871)</li>
        ...
        with st.expander("🔢 أرقام العقود للاختبار"):
            st.markdown("""
            - **3701455886 / 1014871** - Abdenbi (مدفوع، صيانة)
            - **3701455887 / 1014872** - Ahmed (مدفوع، لا صيانة)
            - **3701455888 / 1014873** - محمد (مدفوع، لا صيانة)
            - **3701455889 / 1014874** - خديجة (مدفوع، لا صيانة)
            - **3701455890 / 1014875** - يوسف (غير مدفوع)
            """)
